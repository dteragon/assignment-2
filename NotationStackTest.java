...
public class NotationStackTest {
	...
	public double n1 = 3.8, n2 = 95.2, n3 = 5.03, n4 = 0.175;
	...
	public void testPopStudent() {
		try {
			assertEquals(new Double(n2), doubleS.pop());
			assertEquals(new Double(n1), doubleS.pop());
			//Queue is empty, next statement should cause QueueUnderFlowException
			doubleS.pop();
			assertTrue("This should have caused an StackUnderflowException", false);
		}
	...
	public void testPushStudent() {
		try {
			...
			assertEquals(true, doubleS.push(n3));
			assertEquals(3, doubleS.size());
			assertEquals(true, doubleS.push(n4));
	...
	public void testToStringStudent() {
		assertEquals("3.895.2", doubleS.toString());
		doubleS.push(n3);
		assertEquals("3.895.25.03", doubleS.toString());
		doubleS.push(n4 * n2);
		assertEquals("3.895.25.0316.66", doubleS.toString());
	}
