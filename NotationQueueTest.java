...
public class NotationQueueTest {
	...
	public double n1 = 4.5, n2 = 24, n3 = 712.4, n4 = 9.42;
	...
	public void setUp() throws Exception {
		...
		doubleQ = new NotationQueue<Double>(7);
		doubleQ.enqueue(n1);
		doubleQ.enqueue(n2);
		doubleQ.enqueue(n3);
		doubleQ.enqueue(n4);
	...
	public void testDequeueStudent() {
		try {
			assertEquals(new Double(n1), doubleQ.dequeue());
			assertEquals(new Double(n2), doubleQ.dequeue());
			assertEquals(new Double(n3), doubleQ.dequeue());
			assertEquals(new Double(n4), doubleQ.dequeue());
			//Queue is empty, next statement should cause QueueUnderFlowException
			doubleQ.dequeue();
			assertTrue("This should have caused an QueueUnderflowException", false);
		}
	...
	public void testEnqueueStudent() {
		try {
			...
			assertEquals(true, doubleQ.enqueue(n1));
			assertEquals(5, doubleQ.size());
			assertEquals(true, doubleQ.enqueue(n2));
			assertEquals(true, doubleQ.enqueue(n3));
	...
	public void testToStringStudent() {
		assertEquals("4.524.0712.49.42", doubleQ.toString());
		doubleQ.enqueue(n1);
		assertEquals("4.524.0712.49.424.5", doubleQ.toString());
		doubleQ.enqueue(n3);
		doubleQ.enqueue(n2 + n4);
		assertEquals("4.524.0712.49.424.5712.433.42", doubleQ.toString());
	}
